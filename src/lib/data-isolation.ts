 ...
 * garantir que :
 * 
 * 1. Les rôles internes voient toutes les données
 ...
 * - Tous les rôles internes : pas de filtre (voient tout)
 */
export function getDossierIsolationFilter(
  ...
  // Fallback : rôle non reconnu → uniquement ses dossiers créés
